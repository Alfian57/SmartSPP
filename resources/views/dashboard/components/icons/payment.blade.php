<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="{{ $width ?? '20' }}" height="{{ $height ?? '20' }}"
    fill="{{ $fill ?? 'white' }}"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
    <path
