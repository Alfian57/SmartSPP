...
class MyBillTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Total Tagihan', 'nominal')
                ->format(function ($value) {
                    return view('datatable.my-bills.nominal-column', [
                        'nominal' => $value,
                    ]);
                })
                ->sortable(),
            ...
            Column::make('Nominal Dibayarkan')
                ->label(function ($row) {
                    return view('datatable.my-bills.total-paid-column', [
            ...
            Column::make('Sisa Tagihan')
                ->label(function ($row) {
                    return view('datatable.my-bills.remaining-bill-column', [
            ...
            Column::make('Aksi')
                ->label(function ($row) {
                    return view('datatable.my-bills.action-column', [
                        'id' => $row->id,
                    ]);
                }),
        ];
